...
You will notice that I have renamed this object to `consumer_iso_2` this is for 
...
be new objects. I have continued witb the same renaming nomenclature for objects 
below. 
...
demonstrated in [one source - multiple groups](estimate_trophic_position_one_source_multiple_groups.html). 
