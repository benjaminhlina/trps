...
$$
 ...
 each source and should be bound by 0 and 1. We will see later on that this 
 does not always happen which can be problematic with [Heuvel et al. 2024](https://cdnsciencepub.com/doi/10.1139/cjfas-2024-0028) proposing an new 
...
combined_iso_os <- consumer_iso %>% 
  ...
  left_join(baseline_2_iso, by = c("id", "ecoregion")) 
```
