...
that is based on equations from [Post (2002)](ttps://esajournals.onlinelibrary.wiley.com/doi/abs/10.1890/0012-9658%282002%29083%5B0703%3AUSITET%5D2.0.CO%3B2) and [Vander Zaden and Vadeboncoeur (2002)](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1890/0012-9658%282002%29083%5B2152%3AFAIOBA%5D2.0.CO%3B2).
...
proposing a new 
method to correct (i.e., scale) these values. Estimates of $\alpha$ are used 
...
baselines from two different trophic levels, you can set `lambda` to `2` to 
...
estimates. I will demostrate how to use this model in another vignette. 
