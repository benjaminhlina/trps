...
Posterior distributions will be plotted using [{ggplot2}](https://ggplot2.tidyverse.org/) ](https://ggplot2.tidyverse.org/) 
...
using `left_join()` from [{dplyr}](https://dplyr.tidyverse.org/). We will also 
add in the constant $\lambda$ (`l1`) to our data frame. 
