...
4.  [Wandering the Bayesian countryside with ‘brms’ - 
    Example of a nonlinear mixed-effect model in 
    clinical oncology](https://www.bayes-pharma.org/wp-content/uploads/2019/06/Session-3.1-Fran%C3%A7ois-Mercier.pdf)
5.  [Nonlinear modelling using nls nlme and
    brms](https://www.granvillematheson.com/post/nonlinear-modelling-using-nls-nlme-and-brms/)
6.  [Andrew Proctor's - Module
    6](https://andrewproctor.github.io/rcourse/module6.html)
7.  [van de Schoot et al.,
...
chains is equal (See [{rstan} documentation on
...
done before in combining our outputs and getting the names of each group
