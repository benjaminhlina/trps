...
and `u-95% CI` of `0.19`. These values do make more sense as 
...
an equation in [Heuvel et al. (2024)](https://cdnsciencepub.com/doi/10.1139/cjfas-2024-0028).
...
species or in this case different ecoregions) using iteratstive 
processes that are 
